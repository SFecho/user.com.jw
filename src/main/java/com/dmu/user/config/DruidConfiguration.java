 ...
 *
 * @author SimonFu
 * @version Id: DataSourceConfiguration.java, v 0.1 2019/4/21 15:32 Tisson Exp $$
 */
...
public class DruidConfiguration {
     ...
     *
     * @return
     * @ConfigurationProperties(prefix = "spring.datasource.druid")：作用就是将 全局配置文件中 前缀为 spring.datasource.druid
